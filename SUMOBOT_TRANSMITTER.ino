...
#define JOY_X_PIN 35  // ADC input for joystick X (GPIO 35)
#define JOY_Y_PIN 34  // ADC input for joystick Y (GPIO 34)

uint8_t receiverAddress[] = { 0x00, 0x70, 0x07, 0xE5, 0xC9, 0x4C };  // Receiver MAC
...
// NEW API: Changed callback signature for ESP32 core 3.x
